...
setup_benchmark! {
    ...
    // region: is_{sign}
    fn is_zero(ben: &mut Bencher<'_, CyclesPerByte>) {
        let a = (-1).nanoseconds();
        let b = 0.seconds();
        let c = 1.nanoseconds();
        ben.iter(|| a.is_zero());
    ...
    // region: abs
    fn abs(ben: &mut Bencher<'_, CyclesPerByte>) {
        let a = 1.seconds();
        let b = 0.seconds();
        let c = (-1).seconds();
        ben.iter(|| a.abs());
    ...
    // region: constructors
    fn new(ben: &mut Bencher<'_, CyclesPerByte>) {
    ...
    fn weeks(ben: &mut Bencher<'_, CyclesPerByte>) {
    ...
    fn days(ben: &mut Bencher<'_, CyclesPerByte>) {
    ...
    fn hours(ben: &mut Bencher<'_, CyclesPerByte>) {
    ...
    fn minutes(ben: &mut Bencher<'_, CyclesPerByte>) {
    ...
    fn seconds(ben: &mut Bencher<'_, CyclesPerByte>) {
    ...
    fn seconds_f64(ben: &mut Bencher<'_, CyclesPerByte>) {
        ben.iter(|| Duration::seconds_f64(0.5));
        ben.iter(|| Duration::seconds_f64(-0.5));
    }

    fn seconds_f32(ben: &mut Bencher<'_, CyclesPerByte>) {
        ben.iter(|| Duration::seconds_f32(0.5));
        ben.iter(|| Duration::seconds_f32(-0.5));
    }

    fn milliseconds(ben: &mut Bencher<'_, CyclesPerByte>) {
        ben.iter(|| Duration::milliseconds(1));
        ben.iter(|| Duration::milliseconds(-1));
    }

    fn microseconds(ben: &mut Bencher<'_, CyclesPerByte>) {
        ben.iter(|| Duration::microseconds(1));
        ben.iter(|| Duration::microseconds(-1));
    }

    fn nanoseconds(ben: &mut Bencher<'_, CyclesPerByte>) {
        ben.iter(|| Duration::nanoseconds(1));
        ben.iter(|| Duration::nanoseconds(-1));
    }

    fn whole_weeks(ben: &mut Bencher<'_, CyclesPerByte>) {
    ...
    // region: getters
    fn whole_days(ben: &mut Bencher<'_, CyclesPerByte>) {
    ...
    fn as_seconds_f64(ben: &mut Bencher<'_, CyclesPerByte>) {
        let a = 1.seconds();
        let b = (-1).seconds();
        let c = 1.minutes();
        let d = (-1).minutes();
    ...
    fn as_seconds_f32(ben: &mut Bencher<'_, CyclesPerByte>) {
        let a = 1.seconds();
        let b = (-1).seconds();
        let c = 1.minutes();
        let d = (-1).minutes();
    ...
    fn whole_milliseconds(ben: &mut Bencher<'_, CyclesPerByte>) {
        let a = 1.seconds();
        let b = (-1).seconds();
    ...
    fn subsec_milliseconds(ben: &mut Bencher<'_, CyclesPerByte>) {
        let a = 1.4.seconds();
        let b = (-1.4).seconds();
    ...
    fn whole_microseconds(ben: &mut Bencher<'_, CyclesPerByte>) {
    ...
    fn subsec_microseconds(ben: &mut Bencher<'_, CyclesPerByte>) {
    ...
    fn whole_nanoseconds(ben: &mut Bencher<'_, CyclesPerByte>) {
    ...
    fn subsec_nanoseconds(ben: &mut Bencher<'_, CyclesPerByte>) {
    ...
    fn checked_mul(ben: &mut Bencher<'_, CyclesPerByte>) {
        let a = 5.seconds();
        let b = Duration::MAX;
    ...
    fn checked_div(ben: &mut Bencher<'_, CyclesPerByte>) {
        let a = 10.seconds();
    ...
    fn saturating_add(ben: &mut Bencher<'_, CyclesPerByte>) {
        let a = 5.seconds();
        let b = Duration::MAX;
        let c = Duration::MIN;
        let d = (-5).seconds();
    ...
    fn saturating_sub(ben: &mut Bencher<'_, CyclesPerByte>) {
        let a = 5.seconds();
        let b = Duration::MIN;
        let c = Duration::MAX;
        let d = 5.seconds();
    ...
    fn saturating_mul(ben: &mut Bencher<'_, CyclesPerByte>) {
        let a = 5.seconds();
        let b = 5.seconds();
        let c = 5.seconds();
        let d = Duration::MAX;
    ...
    // region: trait impls
    fn try_from_std_duration(ben: &mut Bencher<'_, CyclesPerByte>) {
        let a = 0.std_seconds();
        let b = 1.std_seconds();
    ...
    fn try_to_std_duration(ben: &mut Bencher<'_, CyclesPerByte>) {
        let a = 0.seconds();
        let b = 1.seconds();
        let c = (-1).seconds();
    ...
    fn std_add(ben: &mut Bencher<'_, CyclesPerByte>) {
        let a = 1.std_seconds();
        let b = 2.seconds();
        ben.iter(|| a + b);
    }
    ...
    fn neg(ben: &mut Bencher<'_, CyclesPerByte>) {
        let a = 1.seconds();
        let b = (-1).seconds();
        let c = 0.seconds();
        ben.iter(|| -a);
    ...
    fn std_sub(ben: &mut Bencher<'_, CyclesPerByte>) {
        let a = 1.std_seconds();
        let b = 2.seconds();
        ben.iter(|| a - b);
    }
    ...
    fn mul_int(ben: &mut Bencher<'_, CyclesPerByte>) {
        let d = 1.seconds();
        ben.iter(|| d * 2);
        ben.iter(|| d * -2);
    }

    fn mul_int_assign(ben: &mut Bencher<'_, CyclesPerByte>) {
        iter_batched_ref!(
            ben,
            || 1.seconds(),
            [
    ...
    fn int_mul(ben: &mut Bencher<'_, CyclesPerByte>) {
        let d = 1.seconds();
        ben.iter(|| 2 * d);
        ben.iter(|| -2 * d);
    }

    fn div_int(ben: &mut Bencher<'_, CyclesPerByte>) {
        let d = 1.seconds();
        ben.iter(|| d / 2);
        ben.iter(|| d / -2);
    }

    fn div_int_assign(ben: &mut Bencher<'_, CyclesPerByte>) {
        iter_batched_ref!(
            ben,
            || 1.seconds(),
            [
    ...
    fn div(ben: &mut Bencher<'_, CyclesPerByte>) {
        let a = 1.seconds();
        let b = 0.5.seconds();
        ben.iter(|| a / b);
    }

    fn mul_float(ben: &mut Bencher<'_, CyclesPerByte>) {
        let d = 1.seconds();
        ben.iter(|| d * 1.5_f32);
        ben.iter(|| d * 2.5_f32);
        ben.iter(|| d * -1.5_f32);
    ...
    fn float_mul(ben: &mut Bencher<'_, CyclesPerByte>) {
        let d = 1.seconds();
        ben.iter(|| 1.5_f32 * d);
        ben.iter(|| 2.5_f32 * d);
        ben.iter(|| -1.5_f32 * d);
    ...
    fn mul_float_assign(ben: &mut Bencher<'_, CyclesPerByte>) {
        iter_batched_ref!(
            ben,
            || 1.seconds(),
            [
    ...
    fn div_float(ben: &mut Bencher<'_, CyclesPerByte>) {
        let d = 1.seconds();
        ben.iter(|| d / 1_f32);
        ben.iter(|| d / 2_f32);
        ben.iter(|| d / -1_f32);
    ...
    fn div_float_assign(ben: &mut Bencher<'_, CyclesPerByte>) {
        iter_batched_ref!(
            ben,
            || 10.seconds(),
            [
    ...
    fn partial_eq(ben: &mut Bencher<'_, CyclesPerByte>) {
        let a = 1.minutes();
        let b = (-1).minutes();
        let c = 40.seconds();
        ben.iter(|| a == b);
    ...
    fn partial_eq_std(ben: &mut Bencher<'_, CyclesPerByte>) {
        let a = (-1).seconds();
        let b = 1.std_seconds();
        let c = (-1).minutes();
        let d = 1.std_minutes();
    ...
    fn std_partial_eq(ben: &mut Bencher<'_, CyclesPerByte>) {
        let a = 1.std_seconds();
        let b = (-1).seconds();
        let c = 1.std_minutes();
        let d = (-1).minutes();
    ...
    fn partial_ord_std(ben: &mut Bencher<'_, CyclesPerByte>) {
        let a = 0.seconds();
        let b = 0.std_seconds();
        let c = 1.seconds();
        let d = (-1).seconds();
    ...
    fn std_partial_ord(ben: &mut Bencher<'_, CyclesPerByte>) {
        let a = 0.std_seconds();
        let b = 0.seconds();
        let c = 1.std_seconds();
        let d = (-1).seconds();
