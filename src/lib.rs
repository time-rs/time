...
impl<'a> Add<&'a Duration, Timespec> for &'a Timespec {
    fn add(self, other: &'a Duration) -> Timespec {
...
impl<'a> Sub<&'a Timespec, Duration> for &'a Timespec {
    fn sub(self, other: &'a Timespec) -> Duration {
